...
c = int (raw_input ("What day of the month is your meter reading taken?: \n"))
while c < 1 or c > 31:
        print 'Bad data'
        print 'Please enter a valid number of days'
        c = int (raw_input ("Enter how many days since last month's reading: \n"))
        
d = int (raw_input ("What day of the month is it today?: \n"))
while d < 1 or d > 31:
        print 'Bad data'
        print 'Please enter a valid number of days'
        c = int (raw_input ("Enter how many days since last month's reading: \n"))       
...
def estwatt(a,b,c,d):
    ...
    if c == d:
        ...
        watts = sofar / (31 - float(c) + d) * 31
    else:
        watts = sofar / (d - c) * 31
    return int(watts)

estwatts = estwatt(a,b,c,d)
print
